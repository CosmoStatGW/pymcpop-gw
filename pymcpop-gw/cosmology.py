...
def Efun(bk, z, Om, w0):
    ...
    """
    a = 1.0 + z
    return bk.sqrt(Om * a**3 + (1.0 - Om) * a ** (3.0 * (1.0 + w0)))
...
def dLfun(bk, z, H0, Om, w0, Xi0, nXi0, *, x01, w01, dc=None, param="vanilla"):
    """
...
# log(dV/dz)
# ---------------------------------------------------------------------
def log_dV_dz(bk, z, H0, Om0, w0, *, dc=None, x01=None, w01=None):
    """
...
def log_ddL_dz(
    ...
    *,
    ...
    if param == "vanilla":
        ...
        term2 = Xi * c_light * onepz / (1.0e03 * H0 * Efun(bk, z, Om0, w0))
        ...
        ddc_dz = c_light / (1.0e03 * H0 * Efun(bk, z, Om0, w0))
